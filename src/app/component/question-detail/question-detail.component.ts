...
export class QuestionDetailComponent implements OnInit {
  showAddAnswerTextbox: boolean = false;

  constructor(public dataService: DataService, private router : Router) { }
  selectedQuestion:any;

  ngOnInit(): void {
    this.selectedQuestion = this.dataService.selectedQuestion;
  ...
  threads = [
    ...
    {'Q.No':3,profilePic: 'https://xsgames.co/randomusers/avatar.php?g=male',title: 'How to add routing in Viu Js?', description: 'Im struck at the concept of routing in Viu. It will be helpful if someone helps me in this', tags: ['Viu','Routes','Technical'], answers: 3, upvotes: 1, views: 21, createdTime: '11-12-2022', category: 'Questions'},
    ...
    {'Q.No':9,profilePic: 'https://xsgames.co/randomusers/avatar.php?g=male',title: 'What are the limitations of React?', description: 'React is not a full-blown framework as it is only a library.', tags: ['React','Limitations','Technical'], answers: 23, upvotes: 1, views: 9, createdTime: '01-11-2022', category: 'Questions'},
    ...
    {'Q.No':11,profilePic: 'https://xsgames.co/randomusers/avatar.php?g=male',title: 'What are keys in React?', description: 'A key is a special string attribute that needs to be included when using lists of elements.', tags: ['React','Keys','Technical'], answers: 13, upvotes: 21, views: 1, createdTime: '01-27-2023', category: 'Questions'},
 ...
 comments = [
  {comment: 'Working Good, thanks'},
  {comment: 'Tried it Good, thanks'},
  {comment: 'Not Working'},
  {comment: 'Working Good, thanks'}
 ]
...
1,2,3
 ...
 showAddAnswer(){
  this.showAddAnswerTextbox = true;
 }
